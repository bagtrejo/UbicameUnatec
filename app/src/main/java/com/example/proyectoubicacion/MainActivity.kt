        ...
        option.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if (options.get(position).equals("Aula 101")){
                    imagen.setImageResource(R.drawable.unahtecmap)
                    ...
                    btn2.setOnClickListener {
                        ...
                        btn3.setBackgroundColor(Color.parseColor("#F0CC38"));
                        imagen.setImageResource(R.drawable.u2)
                    }
                    ...
                    btn3.setOnClickListener {
                        ...
                        imagen.setImageResource(R.drawable.u3)
                    }
                ...
                }else if(options.get(position).equals("Aula 102")){
                    imagen.setImageResource(R.drawable.u4)
                    btn1.setBackgroundColor(Color.parseColor("#044180"));
                    btn2.setBackgroundColor(Color.parseColor("#F0CC38"));
                    btn3.setBackgroundColor(Color.parseColor("#F0CC38"));
                    ...
                    btn2.setOnClickListener {
                        ...
                        btn2.setBackgroundColor(Color.parseColor("#044180"));
                        btn3.setBackgroundColor(Color.parseColor("#F0CC38"));
                        imagen.setImageResource(R.drawable.u5)
                    }
                    ...
                    btn3.setOnClickListener {
                        ...
                        btn2.setBackgroundColor(Color.parseColor("#F0CC38"));
                        btn3.setBackgroundColor(Color.parseColor("#044180"));
                        imagen.setImageResource(R.drawable.u6)
                    }
                    info.setOnClickListener {
                        val builder = AlertDialog.Builder(this@MainActivity,R.style.EstiloDialogoAlerta)
