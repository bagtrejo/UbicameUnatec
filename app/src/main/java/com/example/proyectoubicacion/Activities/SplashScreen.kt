...
class SplashScreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deslizarabajo = AnimationUtils.loadAnimation(this,
            R.anim.deslizarabajo
        )
        val apararicion = AnimationUtils.loadAnimation(this,
            R.anim.apararicion
        )
        val deslizararriba = AnimationUtils.loadAnimation(this,
            R.anim.deslizararriba
        )
